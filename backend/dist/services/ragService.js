...
exports.addDocumentToVectorStore = addDocumentToVectorStore;
exports.queryVectorStore = queryVectorStore;
exports.answerQuestion = answerQuestion;
const chromadb_1 = require("chromadb");
const ollamaService_1 = require("./ollamaService");
// Initialize ChromaDB client
const chromaClient = new chromadb_1.ChromaClient({ path: 'http://localhost:8000' }); // Adjust if different
 ...
 */
async function addDocumentToVectorStore(userId, fileName, content) {
    try {
 ...
 */
async function queryVectorStore(userId, query, nResults = 5) {
    try {
...
Answer:`;
        ...
        const answer = await (0, ollamaService_1.queryOllama)(prompt, 'tinyllama');
        return answer;
    }
    catch (error) {
