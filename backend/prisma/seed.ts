...
async function main() {
  ...
  const node1 = await prisma.node.upsert({
    ...
    create: {
      ...
      ramGb: 256,
      storageGb: 2000,
      supportedModels: ['llama3-8b-8192', 'llama3-70b-8192', 'mixtral-8x7b-32768'],
      pricePerTask: 0.008,
  ...
  const node2 = await prisma.node.upsert({
    ...
    create: {
      ...
      ramGb: 64,
      storageGb: 500,
      supportedModels: ['llama3-8b-8192', 'mistralai/Mistral-7B-Instruct-v0.2'],
      pricePerTask: 0.002,
  ...
  const node3 = await prisma.node.upsert({
    ...
    create: {
      ...
      ramGb: 128,
      storageGb: 1000,
      supportedModels: ['llama3-8b-8192', 'llama3-70b-8192'],
      pricePerTask: 0.005,
