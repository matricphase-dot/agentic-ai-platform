...
// Get all public agents (visible to everyone)
router.get('/public', async (req, res) => {
  try {
    // Assuming agents have an 'isPublic' field or we want to show all active agents
    // For simplicity, we'll show all agents with status 'active' (you can adjust logic)
